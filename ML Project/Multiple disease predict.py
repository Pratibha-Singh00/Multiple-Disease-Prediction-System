...
diabetes_model = pickle.load(open(r'C:\ML Project\diabetes_model.sav','rb'))

heart_disease_model = pickle.load(open(r'C:\ML Project\heart_disease_model.sav','rb'))

parkinsons_model = pickle.load(open(r'C:\ML Project\parkinsons_model.sav','rb'))
